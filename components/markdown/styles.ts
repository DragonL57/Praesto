...
export const listStyles = {
  ...
  unordered:
    'list-disc list-outside ml-6 my-2 space-y-1 text-sm [&_ul]:ml-4 [&_ol]:ml-4 [&_ul]:mt-1 [&_ol]:mt-1',
} as const;

export const blockStyles = {
  hr: 'my-8 border-0 border-t border-zinc-300 dark:border-zinc-700',
  blockquoteWrapper:
    'my-4 px-4 py-2 border-l-4 border-zinc-300 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-900 rounded-r-md',
...
export const citationStyles = {
  button:
    'inline-flex items-center justify-center min-w-4 h-4 px-0 mx-0.5 text-[10px] font-light text-gray-700 bg-gray-200 rounded-[5px] hover:bg-gray-300 dark:bg-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-600 no-underline align-middle text-center',
  hoverCard:
    'w-80 p-3 shadow-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg z-[60]',
  ...
  title:
    'block text-sm font-medium text-gray-900 dark:text-gray-100 leading-tight',
  description:
    'block text-xs text-gray-500 dark:text-gray-400 max-h-20 overflow-hidden text-ellipsis',
