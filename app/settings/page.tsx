              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Select the language for speech recognition or use
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    On-device offers better privacy; cloud offers potentially
                    better accuracy.
                  </p>
                  <Select
                    ...
                    {isCheckingDeviceSupport ? (
                      ...
                      <div className="flex items-center gap-2 text-green-600 dark:text-green-400">
                        ...
                        <span className="text-xs font-medium">
                          {
                            speechLanguages.find(
                              (l) => l.value === selectedLanguage,
                            )?.label
                          }{' '}
                          is available for on-device recognition.
                        </span>
                      </div>
                      ...
                      <div>
                        <div className="flex items-center gap-2 text-amber-600 dark:text-amber-400 mb-2">
                          ...
                          <span className="text-xs font-medium">
                            ...
                            can be downloaded for on-device recognition.
                          </span>
                        </div>
                        <Button
                          variant="outline"
                          ...
                          onClick={() => {
                            ...
                            if (
                              SpeechRecognitionImpl &&
                              typeof SpeechRecognitionImpl.installOnDevice ===
                                'function'
                            ) {
                              toast({
                                type: 'success',
                              ...
                              SpeechRecognitionImpl.installOnDevice(
                                selectedLanguage,
                                ...
                                if (success) {
                                  ...
                                  toast({
                                    type: 'error',
                                    description:
                                      'Failed to install language model.',
                                  });
                                }
                              });
                            }
                      ...
                      <div className="flex items-center gap-2 text-muted-foreground">
                        ...
                        <span className="text-xs">
                          ...
                          is not available for on-device recognition.
                        </span>
                      </div>
                    )}
                  </div>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      ...
                      all of your chat history and remove it from our servers.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
          ...
          <div className="space-y-6 max-w-2xl w-full border rounded-lg bg-muted/30 dark:bg-zinc-800/30 p-6 shadow-sm">
            ...
            <div className="py-4 border-b dark:border-zinc-700">
              <div className="flex justify-between items-center">
                <span className="text-sm font-medium text-muted-foreground w-1/4">
                  Profile
                </span>
            ...
            <div className="py-4 border-b dark:border-zinc-700">
              ...
              <div className="mt-3 pl-[calc(25%+0.75rem)]">
                {' '}
                {/* Aligns with content area, considering gap */}
