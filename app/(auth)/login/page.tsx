        ...
        <div className="w-full max-w-md px-4">
          ...
          >
            <div className="mb-8 text-center">
              ...
              <p className="text-muted-foreground">Sign in to your UniTaskAI account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button type="submit" className="w-full h-12 rounded-full font-medium" disabled={isLoading || isSuccessful}>
                {isLoading ? "Signing in..." : isSuccessful ? "Signed in!" : "Sign in"}
