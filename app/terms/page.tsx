    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <main className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl dark:prose-invert mx-auto">
          <p>
            Welcome to UniTaskAI! These Terms of Service (&quot;Terms&quot;)
            govern your use of our application, website, and services. By
            accessing or using UniTaskAI, you agree to be bound by these Terms.
          </p>
          ...
          <section>
            ...
            <p>
              ...
              are and will remain the exclusive property of UniTaskAI and its
          ...
          <section>
            ...
            <p>
              ...
              post, or display on or through the Service (&quot;User
              Content&quot;). By submitting User Content to the Service, you
            ...
            <p>
              ...
              copyright, trademark, or other intellectual property rights of any
              third party. You agree not to submit User Content that is
              unlawful, defamatory, harassing, threatening, or that encourages
              conduct that would be considered a criminal offense.
            </p>
          </section>

          <section>
            <h2 id="use-of-ai-generated-content">
              6. Use of AI-Generated Content
            </h2>
            <p>
              Content generated by our AI service is provided for informational
              purposes only. While we strive for accuracy and quality, we do not
              guarantee that the AI-generated content will be error-free or
              suitable for any specific purpose.
            </p>
            <p>
              You are solely responsible for reviewing, verifying, and
              validating any AI-generated content before using it for any
              purpose, especially in professional, academic, or commercial
              contexts.
            </p>
            <p>
              You retain full intellectual property rights to AI-generated
              content created through your specific prompts, subject to our
              license to use such content as described in Section 5.
            </p>
          </section>
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                To generate or disseminate false, harmful, or misleading
                information.
              </li>
              <li>
                To attempt to circumvent any content filtering techniques we
                employ.
              </li>
              <li>
                To attempt to gain unauthorized access to our servers, systems,
                or networks.
              </li>
              <li>
              ...
              <li>
                To create or distribute malware, viruses, or other harmful
                computer code.
              </li>
              <li>
                For any unlawful or fraudulent purpose, or to engage in
                deceptive practices.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              In no event shall UniTaskAI, nor its directors, employees,
