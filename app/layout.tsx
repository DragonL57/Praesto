...
export const metadata: Metadata = {
  ...
  description:
    'Transform your workflow with UniTaskAI - the all-in-one AI platform for content creation, code generation, data analysis, and task automation. Try it for free today.',
  keywords: [
    'AI workspace',
    'productivity tool',
    'AI assistant',
  ...
  icons: {
    icon: [{ url: '/UniTaskAI_logo.png' }],
    shortcut: ['/UniTaskAI_logo.png'],
    apple: [{ url: '/UniTaskAI_logo.png' }],
    other: [
      {
        rel: 'mask-icon',
          ...
          >
            <JsonLd
              data={{
                ...
                featureList:
                  'AI Chat, Document Analysis, Code Generation, Data Analysis, Multimodal Input',
