...
export default function Tools() {
  return (
    <main className="mx-auto max-w-3xl">
      ...
      <p className="mb-4">
        This is the placeholder for the Tools & Capabilities section of
        UniTaskAI documentation.
      </p>

      <h2 className="mb-4 mt-8 text-2xl font-semibold">Web Search</h2>
      <p className="mb-4">Placeholder content for web search functionality.</p>
