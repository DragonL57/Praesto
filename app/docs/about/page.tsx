...
export const metadata: Metadata = {
  ...
  description:
    "Learn about UniTaskAI's vision, the problems it solves, and what makes it unique.",
};
    ...
    <main className="mx-auto max-w-3xl prose prose-neutral dark:prose-invert">
      ...
      <section className="mb-16 text-center">
        ...
        <p className="text-2xl font-medium text-muted-foreground mb-2">
          The Intelligent, Action-Oriented AI Assistant
        </p>
        <p className="text-md text-muted-foreground">
          We&apos;re on a mission to make AI a practical, empowering tool for
          everyone.
        </p>
      </section>
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-semibold mb-8 pb-3 border-b text-center">
          Our Vision
        </h2>
        <div className="p-6 border-l-4 border-primary bg-primary/5 rounded-r-md mb-8">
          <p className="text-xl italic text-foreground">
            Transforming AI from conversation to meaningful action, accessible
            to everyone.
          </p>
        </div>
        <p className="mb-8 text-lg text-center">
          UniTaskAI redefines AI assistance by focusing on tangible results. We
          believe AI should be a powerful, practical partner that helps you
          accomplish real tasks efficiently and autonomously.
        </p>
        <div className="grid md:grid-cols-2 gap-6">
          {[
            {
              title: 'Intelligent & Practical',
              description:
                'Solves complex problems with contextual understanding and versatile tools.',
            },
            {
              title: 'Accessible & Affordable',
              description:
                'Brings powerful AI capabilities to users of all backgrounds, without breaking the bank.',
            },
            {
              title: 'Integrated & Seamless',
              description:
                'Fits naturally into your existing workflows with minimal disruption.',
            },
            {
              title: 'Efficient & Autonomous',
              description:
                'Takes initiative to complete tasks with minimal guidance, saving you time.',
            },
          ].map((item) => (
            <div
              key={item.title}
      ...
      <section className="mb-16">
        ...
        <p className="mb-8 text-lg text-center">
          Today&apos;s AI market often forces a difficult choice. UniTaskAI
          bridges this divide:
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div className="p-6 rounded-xl border bg-card shadow-sm">
            ...
            <p className="mb-4 text-sm">
              Great for conversation, but often fall short for complex,
              real-world tasks due to:
            </p>
          ...
          <div className="p-6 rounded-xl border bg-card shadow-sm">
            ...
            <p className="mb-4 text-sm">
              Powerful automation, but typically inaccessible for everyday users
              because of:
            </p>
            <ul className="space-y-2 list-none pl-0">
              {[
        ...
        <div className="mt-8 p-6 bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 rounded-lg text-center shadow">
          <h3 className="text-xl font-semibold mb-2">
            UniTaskAI: Bridging the Gap
          </h3>
          <p className="font-medium text-primary/90">
            UniTaskAI delivers advanced, tool-using AI capabilities at an
            affordable price, making truly practical AI assistance accessible to
            everyone.
          </p>
        </div>
      </section>
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-semibold mb-8 pb-3 border-b text-center">
          Our Solution: UniTaskAI - The Accessible Agent
        </h2>
        <p className="mb-8 text-lg text-center">
          UniTaskAI combines powerful AI models with a suite of practical,
          autonomous tools. We help you accomplish real tasks, all at a price
          point that makes sense for everyday use.
        </p>
            ...
            {[
              {
                ...
                description:
                  'Finds answers from the web in real-time, eliminating app switching.',
              },
              {
                title: 'Context Awareness',
                description:
                  'Provides location-specific info like weather and local data.',
              },
              {
                title: 'Content Creation',
                description:
                  'Creates and manages documents, code, and visualizations via our Artifact system.',
              },
            ].map((tool) => (
              <div
                key={tool.title}
        ...
        <p className="text-center text-muted-foreground">
          Our modern interface (Next.js & shadcn/ui) offers an intuitive
          experience. UniTaskAI proactively suggests and uses the right tools,
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-semibold mb-8 pb-3 border-b text-center">
          Why Choose UniTaskAI?
        </h2>
        <div className="grid md:grid-cols-2 gap-x-8 gap-y-6">
          {[
            {
              title: 'Tool-Powered Assistant',
              description:
                'Goes beyond chat to complete real tasks with autonomous tools.',
              icon: <BrainCircuitIcon />,
            },
            {
              title: 'Flexible Intelligence',
              description:
                'Choose from multiple AI models and personas to match your specific needs.',
              icon: <PuzzleIcon />,
            },
            {
              title: 'Artifact System',
              description:
                'Our innovative approach to organizing and displaying complex outputs with clarity.',
              icon: <ComponentIcon />,
            },
            {
              title: 'Affordability',
              description:
                'Advanced AI capabilities at a fraction of the cost of premium subscriptions and specialized agents.',
              icon: <TagIcon />,
            },
          ].map((prop) => (
            <div
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-semibold mb-8 pb-3 border-b text-center">
          Who We Built UniTaskAI For
        </h2>
        <p className="mb-8 text-lg text-center">
          UniTaskAI is designed for anyone who needs powerful, practical AI
          assistance without the excessive costs or complexity:
        </p>
          ...
          {[
            {
              title: 'Students',
              description:
                'For research, writing aid, and learning support, all affordably.',
            },
            {
              title: 'Educators',
              description:
                'To streamline administrative tasks and create engaging learning materials.',
            },
            {
              title: 'Developers',
              description:
                'To assist with coding, debugging, and documentation, boosting productivity.',
            },
            {
              title: 'Professionals',
              description:
                'To automate routine tasks, analyze data, and enhance daily workflow efficiency.',
            },
            {
              title: 'Small Businesses',
              description:
                'For content creation, customer support, and operational improvements without high overheads.',
            },
            {
              title: 'Knowledge Workers',
              description:
                'Who require intelligent assistance with research, summarization, and information processing.',
            },
          ].map((audience) => (
            <div
              key={audience.title}
...
const TagIcon = () => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a1.994 1.994 0 0 0 2.827 0l7.072-7.072a2 2 0 0 0 0-2.827l-8.703-8.705Z" />
